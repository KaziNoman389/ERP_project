                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted mb-0">Huebee is a JavaScript library for creating user-centric
                                    color pickers. </p>
                            </div>
                            <!--end card-header-->
                            <div class="card-body bootstrap-select-1">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted mb-0">A JavaScript component for choosing date ranges, dates and
                                    times.</p>
                            </div>
                            <!--end card-header-->
                            <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="text-muted  mb-0">A mobile and touch friendly input spinner component for
                                    Bootstrap</p>
                            </div>
                            <!--end card-header-->
                            <div class="card-body">
                                <form>
                                    ...
                                    <div class="form-group">
                                        <label class="mb-3">Value attribute is not set (applying
                                    ...
                                    <div class="form-group mb-0">
                                        <label class="mb-3">Value is set explicitly to 33 (skipping settings.initval)
                                        </label>
